...
const Contact2 = () => (
    <div className="min-h-screen flex items-center justify-center mt-16 py-16">
        <div className="w-full max-w-(--breakpoint-xl) mx-auto px-10 xl:px-10">
            <p className=" text-center text-muted-foreground uppercase font-semibold text-sm">
                Contact Us
            </p>
            <h2 className="text-center mt-3 text-3xl md:text-4xl font-semibold tracking-tight">
                Chat with our friendly team!
            </h2>
            <p className="text-center mt-3 text-base sm:text-lg text-muted-foreground">
